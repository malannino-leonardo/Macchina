...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Car macchina = inizializzaMacchina();
        ...
        macchina.accensioneSpegnimento(false);
    ...
    public static Car inizializzaMacchina() {
        ...
        kmParx = Double.parseDouble(tastiera.nextLine());
        System.out.print("Inserisci valocità media prevista: ");
        int velMedia = Integer.parseInt(tastiera.nextLine());

        Car macchina = new Car(marca, modello, colore, targa, nPorte, Carburante, velMax, capienza, consumo, kmTot, capacitaSerb, livelloSerb, false, velMedia, velMedia);
